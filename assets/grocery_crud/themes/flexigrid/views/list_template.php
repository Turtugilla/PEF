<?php
	...
	$this->set_css($this->default_theme_path.'/flexigrid/css/bootstrap.min.css');
    $this->set_css($this->default_theme_path.'/flexigrid/css/main.css');
    $this->set_css($this->default_theme_path.'/flexigrid/css/responsive.css');
...
<script type='text/javascript'>
	...
	var message_alert_delete = "<?php echo $this->l('alert_delete'); ?>";
		...
		<h1 class="title" style="text-align: center">Administrador</h1>
